...
---------------------------------------------------*/
	...
	function PageLoad() {	
		...
		$(".preloader-wrap").on('mouseleave', function() {					
			gsap.to('#ball', {duration: 0.2, borderWidth: '4px', scale:0.5, borderColor:'#999999', backgroundColor:'white'});
		...
		if( $('.showcase-list-holder').length > 0 ){	
			...
			if (!$("body").hasClass("load-no-ajax")) {
				$('.showcase-list-holder .trigger-slide-link').on('click', function() {
					...
					gsap.to('#ball', {duration: 0.2, borderWidth: '4px', scale:0.5, borderColor:'#999999', backgroundColor:'white', opacity:1});
					gsap.to('#ball-loader', {duration: 0.2, borderWidth: '4px', top: 0, left: 0});
					$("#ball").removeClass("with-icon");
					$('#ball p').remove();
					$('#ball i').remove();							
		...
		setTimeout( function(){
			...
			if( $('.content-slider').length > 0 ){
				...
				var ContentSliderOptions = {				
					...
					spaceBetween: 0,
					mousewheel: {
    invert: true, releaseOnEdges:true},
...
---------------------------------------------------*/
	...
	function AjaxLoad() {		
		...
		$(".link, .button").mouseenter(function(e) {	
			gsap.to('#ball', {duration: 0.2, borderWidth:"0px",scale:1.5,backgroundColor:"white",opacity:0.15});
			gsap.to('#ball-loader', {duration: 0.2, borderWidth: '2px', top: 4, left: 4});
		});			
		$(".link, .button").mouseleave(function(e) {
			gsap.to('#ball', {duration: 0.3, borderWidth:"4px",scale:0.5,backgroundColor:"white",opacity:1});
			gsap.to('#ball-loader', {duration: 0.2, borderWidth: '4px', top: 0, left: 0});
		});
